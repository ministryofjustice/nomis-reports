...
const model = helpers.pipe([
  ...
  ['securityCategory', helpers.getOffenderSecurityCategory2],
  ...
  ['mainOffence', helpers.getOffenderMainOffence],
  ['firstOffence', helpers.getFirstOffenderOffence],
  ['offenderImprisonmentStatus', helpers.getImprisonmentStatus2],
  ['releaseDetails', helpers.getReleaseDetails],
  ['earliestReleaseDate', helpers.getEarliestReleaseDate2],
...
//imp_status_sentence_release_q
    ...
    sentence_length_years: o.offenderSentenceCalculationDates.effectiveSentenceLength.years,
    sentence_length_months: o.offenderSentenceCalculationDates.effectiveSentenceLength.months,
    sentence_length_days: o.offenderSentenceCalculationDates.effectiveSentenceLength.days,
    ...
    jisl_years: o.offenderSentenceCalculationDates.judiciallyImposedSentenceLength.years,
    jisl_months: o.offenderSentenceCalculationDates.judiciallyImposedSentenceLength.months,
    jisl_days: o.offenderSentenceCalculationDates.judiciallyImposedSentenceLength.days,
