...
const CustodyStatusService = require('../../../app/services/CustodyStatusService');

describe('A CustodyStatus Service', () => {
  let exampleSet = [
