...
describe('cde/courtOutcome', () => {
  describe('When court events list contains a conviction', () => {
    ...
    it('Should identify the conviction correctly', () => {
      let result = helpers.getCourtOutcome(input);
      result.should.have.property('eventId', 993558);
      result.should.have.property('outcomeReasonCode', '1015');
    });
  });
});
